  ...
  return (
    <div>
      <div className="tab-toolbar">
        ...
        {/* marginLeft: "auto" (30-й проход — пользователь заметил, что "Ещё"/
            "+ Добавить" на «Клиентах» и «Оборудовании» стоят в разных местах):
            при узком окне и большом наборе фильтров слева .tab-toolbar
            переносит эту группу на вторую строку — а justify-content:
            space-between у родителя выравнивает элементы ТОЛЬКО в пределах
            одной строки, поэтому единственный элемент на новой строке
            прижимался к левому краю вместо правого (см. styles.css,
            .tab-toolbar). auto-отступ решает это сам, без переноса всего
            тулбара в column — прижимает группу к правому краю что на общей
            строке с фильтрами, что на отдельной, если перенос всё же
            случился, — за счёт этого кнопки всегда в одном и том же месте
            независимо от того, сколько фильтров помещается слева. */}
