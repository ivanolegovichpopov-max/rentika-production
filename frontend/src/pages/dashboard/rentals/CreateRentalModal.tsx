    ...
    >
      <div className="field">
        ...
        {/* "+ Добавить нового клиента" — в одной строке с Dropdown'ом,
            ...
            Цвет ссылки (62-й проход) — обратно акцентный синий var(--accent),
            как и был изначально у .link-btn: приглушение до var(--muted) в
            60-м проходе было промежуточной попыткой снять ощущение "большая
            кнопка", но прямым указанием пользователь вернул именно исходный
            синий — никакого inline-override цвета больше нет, ссылка снова
            наследует цвет прямо из класса .link-btn.
