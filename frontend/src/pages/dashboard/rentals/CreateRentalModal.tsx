    ...
    >
      <div className="field">
        ...
        {/* "+ Добавить нового клиента" — под полем, прижата вправо (59-й
            ...
            только теперь ещё и textAlign:"right" вместо левого края, чтобы
            остаться на нужной стороне. Пока открыта панель быстрого
        ...
        {!quickAddOpen && (
          <button
            type="button"
            className="link-btn"
            style={{ display: "block", textAlign: "right", marginTop: "8px" }}
