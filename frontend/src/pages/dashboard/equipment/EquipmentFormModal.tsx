...
export function EquipmentFormModal({
  ...
  return (
    <dialog
      ...
      // п.16 обзора — та же правка, что и у ClientFormModal.tsx: форма
      // оборудования тоже многополая, случайный клик рядом с окном не
      // должен рисковать потерянными данными, даже с confirm-подтверждением
      // на пути — само его неожиданное появление уже риск при рефлекторном
      // "закрыть кликом мимо"). Явное закрытие (крестик/"Отмена") и Escape
      // по-прежнему идут через requestClose() (см. onCancel выше).
    >
