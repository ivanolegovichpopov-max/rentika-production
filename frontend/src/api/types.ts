...
export interface Employee {
  ...
  // Включена ли 2FA у аккаунта (доп. проход после 67-го) — та же
  // видимость, что phone/email: null для всех, кроме владельца/
  // платформенного админа. Нужно, чтобы сопоставить с Position.require_2fa
  // и подсветить реальный пробел в защите.
